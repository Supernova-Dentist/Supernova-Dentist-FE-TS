...
export const MembershipPlansTimeline = ({ data }: TimelineProps) => {
  ...
  return (
    <div id='membership-plans-timeline' className='w-full font-sans xl:px-10' ref={containerRef}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        <div className='max-w-7xl mx-auto py-20 px-4 xl:px-8 lg:px-10'>
          ...
          <h2 className='text-3xl xl:text-4xl lg:text-5xl font-bold text-center mb-2 text-gold'>
            Your Dental Membership Plan Journey
          </h2>
          ...
          <p className='text-xl xl:text-2xl lg:text-2xl text-center text-gray-800 max-w-[35rem] mx-auto'>
            Our dental membership plans are designed to make dental care simple and affordable. Here&apos;s what you can
