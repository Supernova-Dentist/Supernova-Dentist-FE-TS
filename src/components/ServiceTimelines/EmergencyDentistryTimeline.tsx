...
export const EmergencyDentistryTimeline = ({ data }: TimelineProps) => {
  ...
  return (
    <div id='emergency-dentistry-timeline' className='w-full  font-sans xl:px-10' ref={containerRef}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        {/* Header Section */}
        <div className='max-w-7xl mx-auto pt-6 px-4 xl:px-8 lg:px-10'>
          ...
          {data.map((item, index) => (
            <div key={index} className='flex justify-start pt-10 xl:pt-20 xl:gap-10'>
              ...
              <div className='sticky flex flex-col xl:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm xl:w-full'>
                ...
                <h3 className='hidden xl:block text-xl xl:pl-20 xl:text-5xl font-bold text-neutral-500 dark:text-neutral-500'>
                  {item.title}
                </h3>
              </div>
