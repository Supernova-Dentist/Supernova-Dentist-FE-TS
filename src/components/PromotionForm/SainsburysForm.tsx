...
export default function ImplantPromotionForm() {
  ...
  async function onSubmit(data: PromotionFormData) {
    try {
      ...
      if (!cleanedSource) cleanedSource = 'bridgwater-sainsburys'; // Default source if pathname is empty
          ...
          <div className='container mx-auto max-w-[1200px] grid lg:grid-cols-2 gap-10 items-center px-2'>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
                  ...
                  <p className='text-xs text-gray-500 text-center'>
                    No pressure, no obligation - our friendly team will help you understand the best options for your
                    dental needs.
                  </p>

                  {/* NEXT STEPS */}
                  <div className='text-sm text-gray-600 space-y-1'>
                    <p>✔ Discuss your dental goals with our friendly team</p>
                    <p>✔ Understand your treatment options clearly</p>
            ...
            <div className='hidden lg:block relative w-full h-full rounded-2xl overflow-hidden'>
              <img
                ...
                alt="Supernova Dental private dentist in Bridgwater near Sainsbury's"
              />
            </div>
          </div>
        </motion.div>
