export default {
  ...
  mainText:
    'A Root Canal Treatment is crucial for preserving a tooth that is severely decayed or infected. Our experienced dental team will carefully remove the infected pulp, clean and disinfect the root canals, and fill them to restore the tooth’s function and health. This procedure helps alleviate pain and prevent further complications, allowing you to keep your natural tooth.',
  benefitText:
