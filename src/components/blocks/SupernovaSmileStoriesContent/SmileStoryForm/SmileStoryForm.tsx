...
export default function SmileStoryForm({
  serviceChip,
  serviceName,
  serviceDescription,
  formTitle,
  ...
  async function onSubmit(data: PromotionFormData) {
    try {
      ...
      const dataWithSource = {
        ...
        tracking: buildSubmissionTracking({ form: 'smile-story', service: serviceName }),
      };
      ...
      // Google Ads conversion for new patients
          ...
          <div className='container max-w-[1250px] mx-auto px-4 md:px-8 lg:grid lg:grid-cols-2 gap-8'>
            ...
            <div className='text-center lg:text-left space-y-6'>
              ...
              <div className='hidden lg:flex items-center justify-center mx-auto gap-4 pt-4 pb-8'>
                <img
                  src='/assets/images/smile_story.jpeg'
                  alt='Supernova Smile Story'
                  className=' w-11/12 rounded-lg shadow-xl'
                />
              </div>
            </div>
            ...
            <Card className=' max-h-[50rem] md:max-h-[40rem] mt-6 mx-auto lg:m-auto w-full max-w-lg bg-gray-50 shadow-2xl p-2 md:p-6 flex items-center justify-center'>
              <form id={'smile-story-form'} onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50'>
          <div className='bg-white p-10 rounded-lg shadow-lg max-w-md w-full relative'>
            ...
            <h2 className='text-3xl font-semibold mb-6'>
              Thank you, {values.fullname}, for starting your smile journey!
            </h2>
            <div className='mb-6 flex flex-col gap-2'>
              <p>We’ll send your consultation details to {values.email}.</p>
              <p>Please check your spam folder if you don’t see it in your inbox.</p>
            </div>
            <p className='mb-2'>Prefer to book directly? Use our patient portal:</p>
