...
import teethwhiteningImage from '../../../../../public/assets/images/cosmetic-dentistry-supernova-dental-bridgwater.webp';
...
export default function TeethWhiteningIntroSection() {
  // Animation variants
    ...
    >
      ...
      >
        ...
        <h2 className='text-3xl font-bold tracking-tighter md:text-4xl lg:text-5xl mt-8'>
          Professional teeth whitening in Bridgwater, Somerset
        </h2>
        <p className='mt-4'>
          If you’re looking for safe and effective teeth whitening, Supernova Dental offers professional treatments
          designed to brighten your smile. Our experienced{' '}
          <Link href='/team' className='underline text-gold hover:text-lightGold'>
            dental team
          </Link>{' '}
          provides dentist-supervised whitening using trusted formulas to gently remove stains and reveal a naturally
          whiter smile.
        </p>
      ...
      >
        <Image
          ...
          alt='Teeth Whitening Treatment in Bridgwater, Somerset'
          width={1824}
          height={1216}
          quality={75}
          placeholder='blur'
