    ...
    <section className='text-slate-100 overflow-hidden bg-lightGrey px-8 py-24 md:px-12 md:py-32'>
      <div className='relative mx-auto max-w-5xl flex flex-col md:flex-row items-center'>
        <div className='pointer-events-none relative z-10 md:flex-1 '>
          <Reveal>
            <h1 className='pointer-events-auto text-6xl font-black text-slate-100 md:text-8xl'>
              Hi, I&apos;m Paula<span className='text-lightGold'>.</span>
            </h1>
          </Reveal>
          <Reveal>
            <>
              <h2 className='pointer-events-auto my-2 text-2xl text-cream md:my-4 md:text-4xl'>
                I&apos;m a <span className='font-semibold text-lightGold'>Receptionist</span>
              </h2>
            </>
          </Reveal>
          <Reveal>
            <>
              <p className='pointer-events-auto max-w-xl text-sm text-cream md:text-base mt-4'>
                Hi everyone! My name is Paula. I have joined the team as front desk receptionist and I am so excited to
                become part of this amazing team here at Supernova.
              </p>
              <p className='pointer-events-auto max-w-xl text-sm text-cream md:text-base mt-4'>
                From scheduling your appointments to answering any questions you may have, I&apos;m here to help every
                step of the way. Whether you&apos;re already a patient or new to the practice, I look forward to
                ensuring you feel comfortable throughout your journey with us.
              </p>
              <p className='pointer-events-auto max-w-xl text-sm text-cream md:text-base mt-4'>
                If you ever need assistance or have any concerns, don’t hesitate to reach out I’m just a phone call
                away. We’re currently accepting new patients, so if you or someone you know is looking for a caring
                dental team, we’d love to meet you!
              </p>
              <p className='pointer-events-auto max-w-xl text-sm text-cream md:text-base mt-4'>
        ...
        <div className='pointer-events-none relative z-10 mt-8 md:mt-0 md:ml-12 md:flex-1'>
          <Reveal>
            <Image
              src='/assets/images/Headshots/paula.jpeg'
...
export default PaulaWaterDropHero;
