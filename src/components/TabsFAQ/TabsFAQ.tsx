...
export const TabsFAQ = () => {
  ...
  return (
    <section className='flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-white to-cream  px-4 py-24 min-h-screen-minus-nav'>
      <Heading />
  ...
  return (
    <>
      <div className='relative flex flex-col items-center justify-center'>
        <span className='mb-8 p-8 bg-black bg-clip-text font-medium text-transparent'>
  ...
  return (
    ...
    >
      <button onClick={() => setOpen((pv) => !pv)} className='flex w-full items-center justify-between gap-4 py-4'>
        <span className={`text-left text-lg font-medium transition-colors ${open ? 'text-white' : 'text-white'}`}>
          {question}
        </span>
        <motion.span
          variants={{
