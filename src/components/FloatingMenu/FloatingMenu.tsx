...
function QuickAction({
  ...
  return (
    <a
      ...
      tabIndex={tabIndex}
      className='flex flex-col items-center justify-center gap-1.5 border-r border-black/60 px-2 text-center text-base font-medium leading-tight last:border-r-0 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-4px] focus-visible:outline-white'
    >
