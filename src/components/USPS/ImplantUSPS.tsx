...
import { BadgeCheck, CreditCard, Group, LucideSmile, Sparkles, Stethoscope, User, Users, Users2 } from 'lucide-react';
import { FaTeamspeak, FaTeethOpen } from 'react-icons/fa';
import { GiTooth } from 'react-icons/gi';

export default function ImplantUSPS() {
  const usps = [
    {
      title: 'Experienced Implant Dental Team',
      icon: User,
    },
    {
    ...
    {
      title: 'Fixed Teeth Solutions That Look Natural',
      icon: GiTooth,
    },
    {
