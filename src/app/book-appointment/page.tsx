...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.supernovadental.co.uk/book-appointment',
    type: 'website',
    images: [
      {
...
export default function Home() {
  ...
  return (
    <main className='campaign-experience min-w-0 overflow-x-clip bg-porcelain text-obsidian'>
      ...
      />
      <GeneralSparklesPreview />
      <section id='consultation-form' className='scroll-mt-24 bg-porcelain px-5 py-16 sm:px-8 lg:px-12 lg:py-24' aria-label='Dental appointment enquiry'>
