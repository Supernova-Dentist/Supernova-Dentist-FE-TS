  ...
  return ReactDOM.createPortal(
    <div className='fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75'>
      ...
      >
        ...
        <div
          className='relative w-full h-[50vh]' // Set height for the media container
          style={{
            // Use paddingTop for a ratio on the video, but allow flexibility for both images and videos
            paddingTop: post.media_type === 'VIDEO' ? '56.25%' : '100%', // 16:9 ratio for video, 1:1 for images
          }}
        >
          {post.media_type === 'VIDEO' ? (
            <video controls className='absolute inset-0 left-0 w-full h-full object-contain rounded-t-lg'>
