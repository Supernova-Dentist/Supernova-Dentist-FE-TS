...
const formSchema = z.object({
  ...
  positionInterest: z.string().min(1, { message: 'Please select a position of interest.' }),
...
export function CareerFormContent() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      formData.append('enquiryType', 'Career-Interest');
      formData.append('tracking', JSON.stringify(buildSubmissionTracking({ form: 'careers', service: 'Career interest' })));
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleSubmit, onError)} className='space-y-8'>
                <div className='grid gap-6'>
                  ...
                  <div className='space-y-3'>
                    <Label htmlFor='positionInterest' className='text-lg font-medium'>
                              ...
                              render={({ field }) => (
                                <Select onValueChange={field.onChange} value={field.value || ''} defaultValue=''>
                                  <SelectTrigger id='positionInterest'>
                                    <SelectValue placeholder='Select a position' className='text-md lg:text-lg' />
                                  </SelectTrigger>
                                  <SelectContent>
                                    <SelectItem value='associateDentist' className='text-md lg:text-lg'>
                                      Associate Dentist
                                    </SelectItem>
                                    <SelectItem value='dentalNurse' className='text-md lg:text-lg'>
                                      Dental Nurse
                                    </SelectItem>
                                    <SelectItem value='traineeDentalNurse' className='text-md lg:text-lg'>
                                      Trainee Dental Nurse
                                    </SelectItem>
                                    <SelectItem value='dentalHygienist' className='text-md lg:text-lg'>
                                      Dental Hygienist
                                    </SelectItem>
                                    <SelectItem value='receptionist' className='text-md lg:text-lg'>
                                      Receptionist
                                    </SelectItem>
                                    <SelectItem value='practiceManager' className='text-md lg:text-lg'>
                                      Practice Manager
                                    </SelectItem>
                                    <SelectItem value='treatmentCoordinator' className='text-md lg:text-lg'>
        ...
        <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50'>
          <div className='bg-white p-8 rounded-lg shadow-lg max-w-sm w-full'>
            <h2 className='text-2xl font-semibold mb-4'>
              Thank you {submittedData.firstName}, we&apos;ve received your expression of interest in joining the team
              at Supernova Dental!
            </h2>
            <p className='mb-4'>
              While we may not respond to every submission when not actively recruiting for the role of interest, please
              know that we truly appreciate your interest. We&apos;ll keep your details on file and be in touch if a
