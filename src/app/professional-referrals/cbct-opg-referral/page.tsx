...
export const metadata: Metadata = {
  title: 'CBCT & OPG Referral | Supernova Dental, Bridgwater, Somerset',
  description:
    'Refer your patients for high-quality CBCT and OPG dental imaging at Supernova Dental in Bridgwater. Quick turnaround, expert interpretation, and seamless digital referrals.',
  keywords:
    'CBCT referral Bridgwater, OPG referral Somerset, dental imaging referral, 3D dental scan Bridgwater, Supernova Dental CBCT, dental CT scan Somerset, professional dental referral, CBCT OPG Bridgwater, dental radiography referral, dentist imaging Somerset',
};
