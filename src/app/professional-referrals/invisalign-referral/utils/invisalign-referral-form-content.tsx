...
const formSchema = z.object({
  ...
  treatmentRequired: z.string().min(5, { message: 'Please provide the treatment required.' }),
...
export function InvisalignReferralFormContent() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      formData.append('referralType', 'Invisalign');
      formData.append('tracking', JSON.stringify(buildSubmissionTracking({ form: 'professional-referral', service: 'Invisalign' })));
            ...
            <Form {...form}>
              <form id='printable-cbct-form' onSubmit={form.handleSubmit(handleSubmit, onError)} className='space-y-8'>
                <div className='grid gap-6'>
                  ...
                  <div className='space-y-3'>
                    <Label htmlFor='treatmentRequired' className='text-lg font-medium'>
                      Treatment Required:
                    </Label>
                    <FormField
                      control={form.control}
