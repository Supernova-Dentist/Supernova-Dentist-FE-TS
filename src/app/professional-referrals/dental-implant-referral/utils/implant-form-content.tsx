...
export function ImplantReferralFormContent() {
                ...
                <div className='grid gap-6'>
                  ...
                  <div className='space-y-3'>
                    <Label htmlFor='referralPurpose' className='text-lg font-medium'>
                      Type of Referral (fees collected directly from the patient)
                    </Label>
                    <FormField
                      control={form.control}
                            ...
                            <Controller
                              ...
                              render={({ field }) => (
                                <Select onValueChange={field.onChange} value={field.value || ''} defaultValue=''>
                                  ...
                                  <SelectContent>
                                    <SelectItem value='assessmentOnly' className='text-md lg:text-lg'>
                                      Assessment Only
                                    </SelectItem>

                                    <SelectItem value='implantPlacement' className='text-md lg:text-lg'>
                                      Implant Placement
                                    </SelectItem>
                                    <SelectItem value='augmentation' className='text-md lg:text-lg'>
                                      Augmentation
                                    </SelectItem>
                                    <SelectItem value='fullTreatment' className='text-md lg:text-lg'>
                                      Full Treatment
                                    </SelectItem>
