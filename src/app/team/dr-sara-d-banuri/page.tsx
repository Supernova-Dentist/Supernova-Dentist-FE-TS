...
export const metadata = {
  title: 'Dr. Sara D Banuri | Expert Implantologist Bridgwater, Somerset',
  description:
    'Dr. Sara D Banuri is a leading implantologist in Bridgwater, Somerset. Specialising in single-tooth, multiple-tooth, and full-arch dental implants including All-on-4 solutions. Book your consultation today!',
  keywords:
...
const structuredData = {
  ...
  image: 'https://www.supernovadental.co.uk/assets/images/Headshots/sara.jpg',
  url: 'https://www.supernovadental.co.uk/team/dr-sara-d-banuri',
  ...
  return (
    <>
      <Head>
        ...
        <link rel='canonical' href='https://www.supernovadental.co.uk/team/dr-sara-d-banuri' />
              ...
              <Reveal>
                <>
                  ...
                  <p className='text-lg text-white md:text-xl max-w-2xl mt-2 mx-auto'>
                    ...
                    solutions like All-on-4 can restore your smile and confidence.
                  </p>
