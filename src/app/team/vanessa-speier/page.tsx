import { MiaOutlineCards } from '@/components/OutlineCards/MiaOutlineCards';
import VanessaWaterDropHero from '@/components/WaterDropHeros/VanessaWaterDropHero';
import { Reveal } from '@/utils/anim/Reveal';

export default function Component() {
  return (
    <div className='flex flex-col min-h-[100vh]'>
      <VanessaWaterDropHero />
